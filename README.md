...
#### Github
- Enter this url: [https://github.com/Efiamotu-1/hello-rails-backend](https://github.com/Efiamotu-1/hello-rails-backend) in your web browser.
...
```sh
  git clone https://github.com/Efiamotu-1/hello-rails-backend.git
```
...
- After cloning type `cd hello-rails-backend` to access the project on the terminal.
